      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-50 rounded-2xl p-6 h-fit sticky top-24">
          ...
          <div className="space-y-2 text-sm mb-4">
            ...
            <div className="flex justify-between"><span>Livraison</span><span>{shipping === 0 ? <span className="text-green-600 font-semibold">Gratuite</span> : formatPrice(shipping)}</span></div>
